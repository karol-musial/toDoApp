...
class ProjectServiceTest {
    ...
    void createGroup_oneNoneMultipleGroupsConfig_and_openGroupExists_throwsIllegalStateException() {
        // given
    ...
    void createGroup_configurationOk_existingProject_createsAndSavesGroup() {
        ...
        TaskConfigurationProperties mockConfig = configurationReturning(true);
        //system under test
        var toTest = new ProjectService(mockRepository, inMemoryGroupRepo, serviceWithInMemory, mockConfig);
        // when
    ...
    private Project projectWith(String projectDescription, Set<Integer> daysToDealdine) {
        Set<ProjectStep> steps = daysToDealdine.stream()
                .map(days -> {
